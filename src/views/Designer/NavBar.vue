      ...
      <div class="relative flex justify-between h-16">
        ...
        >
          ...
          <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
            ...
            <!-- here Nick will handle routing. or he will have an idea how to approach to that. But anyway just simple looping with emiting event. -->
            <div
              v-for="element in navBarData.redirectSection"
              :key="element.id"
            >
              <div
